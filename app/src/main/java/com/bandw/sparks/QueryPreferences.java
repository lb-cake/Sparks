...
public class QueryPreferences {
    ...
    private static final String sPrefSearchQuery = "PREF_SEARCH_QUERY";
    private static final String sPrefLastResultId = "PREF_LAST_RESULT_ID";
    public static final String sPrefCurrentPage = "PREF_CURRENT_PAGE";
    private static final String sPrefIsAlarmOn = "PREF_IS_ALARM_ON";
